...
1. 迁移`greuseport`模块到新的仓库：https://github.com/yyf330/greuseport
1. 大量的单元测试完善；
...
## 新特性
1. 主库从`gitee`迁移到了`github`( https://github.com/yyf330/gf )，`gitee`作为镜像站，用于国内的代码贡献及ISSUE提交，迁移说明详见：https://goframe.org/upgradeto150
1. 对常用的`container`数组模块: `garray`做了大量改进/完善工作，新增大量常用方法，并完善单元测试用例及方法注释，详见API文档：https://godoc.org/github.com/yyf330/gf/container/garray
1. 对常用的`container`集合模块: `gset`做了大量改进/完善工作，新增大量常用方法，并完善单元测试用例及方法注释，详见API文档：https://godoc.org/github.com/yyf330/gf/container/gset
1. 对常用的`container`MAP模块: `gmap`做了大量改进/完善工作，新增大量常用方法，并完善单元测试用例及方法注释，详见API文档：https://godoc.org/github.com/yyf330/gf/container/gmap
1. 对常用的字符串模块: `gstr`做了大量改进/完善工作，新增大量常用方法，并完善单元测试用例及方法注释，详见API文档：https://godoc.org/github.com/yyf330/gf/text/gstr
...
1. 由于`gkafka`模块比较重，且不是框架核心模块，因此将该模块迁移到新的仓库中独立管理，并去掉相关依赖包：https://github.com/yyf330/gkafka
1. 新增`greuseport`模块，用以实现TCP的`REUSEPORT`特性：https://godoc.org/github.com/yyf330/gf/net/greuseport
...
1. bug fix INZS1([https://github.com/yyf330/gf/issues/INZS1](https://github.com/yyf330/gf/issues/INZS1));
...
# `v0.97.399 beta` (2018-04-23)
    ...
    14、修复ISSUE:
        #IISWI github.com/yyf330/gf/issues/IISWI,
        #IISMY github.com/yyf330/gf/issues/IISMY,
